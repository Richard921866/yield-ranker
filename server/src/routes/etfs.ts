...
async function handleStaticUpload(req: Request, res: Response): Promise<void> {
  ...
  try {
    ...
    // Category is optional - defaults to CCETF for backward compatibility
