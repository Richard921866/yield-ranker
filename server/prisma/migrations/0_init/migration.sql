...
CREATE TABLE "etfs" (
    ...
    "forward_yield" DECIMAL,
    "standard_deviation" DECIMAL,
    "week_52_low" DECIMAL,
    "week_52_high" DECIMAL,
    "total_return_3yr" DECIMAL,
    "total_return_12mo" DECIMAL,
    "total_return_6mo" DECIMAL,
    "total_return_3mo" DECIMAL,
    "total_return_1mo" DECIMAL,
    "total_return_1wk" DECIMAL,
    "updated_at" TIMESTAMPTZ(6) DEFAULT CURRENT_TIMESTAMP,
    "annual_div" DECIMAL,
    "pay_day" TEXT,
    "payments_per_year" INTEGER,
    "dividend_volatility_index" DECIMAL,
    "weighted_rank" DECIMAL,
    "three_year_annualized" DECIMAL,
    "total_return_12m" DECIMAL,
    "total_return_6m" DECIMAL,
    "total_return_3m" DECIMAL,
    "total_return_1m" DECIMAL,
    "total_return_1w" DECIMAL,
    "spreadsheet_updated_at" TIMESTAMPTZ(6),
    "favorites" BOOLEAN DEFAULT false,
    "created_at" TIMESTAMPTZ(6) DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "etfs_pkey" PRIMARY KEY ("symbol")
);
...
CREATE TABLE "favorites" (
    ...
    CONSTRAINT "favorites_pkey" PRIMARY KEY ("user_id","symbol")
);
...
-- CreateIndex
CREATE INDEX "idx_etfs_forward_yield" ON "etfs"("forward_yield");
...
-- CreateIndex
CREATE INDEX "idx_etfs_total_return_12m" ON "etfs"("total_return_12m");

-- CreateIndex
CREATE INDEX "idx_etfs_updated_at" ON "etfs"("spreadsheet_updated_at");

-- CreateIndex
CREATE INDEX "idx_etfs_weighted_rank" ON "etfs"("weighted_rank");
...
-- CreateIndex
CREATE UNIQUE INDEX "site_messages_message_type_key" ON "site_messages"("message_type");

-- CreateIndex
CREATE INDEX "idx_site_messages_type" ON "site_messages"("message_type");
...
-- AddForeignKey
ALTER TABLE "favorites" ADD CONSTRAINT "favorites_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "saved_screeners" ADD CONSTRAINT "saved_screeners_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "site_settings" ADD CONSTRAINT "site_settings_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "auth"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
