...
function printTable(rankedCEFs: RankedCEF[], weights: Weights) {
  ...
  console.log("=".repeat(150));
  console.log(`Weights: YIELD=${weights.yield}%, Z-SCORE=${weights.zScore}%, TR 12MO=${weights.return12Mo}%, TR 6MO=${weights.return6Mo}%, TR 3MO=${weights.return3Mo}%`);
  console.log("=".repeat(150));
  console.log();
  ...
  console.log("=".repeat(150));
  console.log("NOTES:");
  console.log("- 1 = BEST, higher numbers = WORSE");
