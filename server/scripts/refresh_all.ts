...
async function main() {
  ...
  // Note: CEF refresh is handled by package.json "refresh:all" script
  // which runs refresh_cef.ts after refresh_all.ts completes
  // No need to call it here to avoid running it twice
